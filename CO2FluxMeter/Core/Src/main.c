...
void bufclear(char *buff, size_t length)
{
...
int main(void)
{
  ...
  /*start timer 2 for microsecond delays*/
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, PROB2_Pin|PROB4_Pin|PROB1_Pin|PROB3_Pin
                          |SD_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PROB2_Pin PROB4_Pin PROB1_Pin PROB3_Pin
                           SD_NSS_Pin */
  GPIO_InitStruct.Pin = PROB2_Pin|PROB4_Pin|PROB1_Pin|PROB3_Pin
                          |SD_NSS_Pin;
